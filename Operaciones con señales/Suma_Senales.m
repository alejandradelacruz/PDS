...
subplot(3,1,3), plot(t,z); title("suma de las 2 señales"); xlabel("tiempo"); ylabel("z(t)");
...
subplot(3,1,3), stem(n,z2); title("suma de las 2 señales en tiempo discreto"); xlabel("n"); ylabel("z2[n]");